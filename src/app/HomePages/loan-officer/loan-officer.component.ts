...
export class LoanOfficerComponent implements OnInit {
  ...
  constructor(private loginService: LoginService, private api: ApiService, private router: Router) { }
  _loggedIn = false;
  _type: string;
  tempReport: Report;
  ...
  ngOnInit() {
    if (this.loginService.type !== 'loanOfficer') {
  ...
  // this is used to pass data of a report clicked on the the viewing modal
